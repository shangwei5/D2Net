...
class CDVD_TSP(nn.Module):
    ...
    def forward(self, x, bm, label):
        ...
        recons_1, _ = self.recons_net(concated, bm_list[1], label[:, 1].squeeze())
        ...
        recons_2, _ = self.recons_net(concated, bm_list[2], label[:, 2].squeeze())
        ...
        recons_3, _ = self.recons_net(concated, bm_list[3], label[:, 3].squeeze())
        ...
        out, _ = self.recons_net(concated, bm_list[2], label[:, 2].squeeze())
