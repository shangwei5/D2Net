...
parser.add_argument('--template', default='D2NET',
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='../dataset/GOPRO_Random/train',
                    help='dataset directory')
parser.add_argument('--dir_data_test', type=str, default='../dataset/GOPRO_Random/test',
                    help='dataset directory')
...
parser.add_argument('--pretrain_models_dir', type=str, default='../pretrain_models/',
                    help='file name to save')
parser.add_argument('--save', type=str, default='D2Net',
                    help='file name to save')
